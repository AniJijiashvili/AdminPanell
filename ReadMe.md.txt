This project is a fully responsive Admin Panel built using React, TypeScript, Material-UI, and Vite. It demonstrates the basic CRUD functionality and data visualization for managing user data.
